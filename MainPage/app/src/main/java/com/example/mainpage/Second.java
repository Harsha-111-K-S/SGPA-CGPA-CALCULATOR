...
public class Second extends AppCompatActivity implements View.OnClickListener{
    EditText et1,et2,et3,et4,et5,et6,et7,et8,etResult;
    ...
    public void onClick(View v)
    {
        ...
        if(v.equals(btnSubmit))
        {
            ...
            int lab2 = Integer.parseInt(String.valueOf(et8.getText()));
            ...
            int c7 = GradePoints(lab1);
            int c8 = GradePoints(lab2);

            int sum = ((c1*4)+(c2*4)+(c3*3)+(c4*3)+(c5*3)+(c6*1)+(c7*1)+(c8*1));
